<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="projects.aspx.cs" Inherits="elpida.projects" %>
            ...
            <div class="row">
                <div class="col-md-12"> 
                    <div class="page-title-heading">
                        <h1 class="title">Project List 1 Column</h1>
        ...
        <div class="container">
            <div class="post-wrap project-v1 post-list clearfix">
                <article class="entry border-shadow clearfix">
                    <div class="entry-border clearfix">
                        <div class="featured-post">
                            <a href="single-post.html"> <img src="images/blog/pl1.jpg" alt="image"></a>
                        </div><!-- /.feature-post -->
                        <div class="content-post">
                            <span class="category">Advisory Plan</span>
                            <h2 class="title-post"><a href="single-post.html">Colombia Gets a Business Makeover</a></h2>
                ...
                <article class="entry border-shadow clearfix">
                    <div class="entry-border clearfix">
                        <div class="featured-post">
                            <a href="single-post.html"> <img src="images/blog/pl2.jpg" alt="image"></a>
                        </div><!-- /.feature-post -->
                        <div class="content-post">
                            <span class="category">Advisory Plan</span>
                            <h2 class="title-post"><a href="single-post.html">CV-Library now largest CV da-tabase in UK</a></h2>
                ...
                <article class="entry border-shadow clearfix">
                    <div class="entry-border clearfix">
                        <div class="featured-post">
                            <a href="single-post.html"> <img src="images/blog/pl3.jpg" alt="image"></a>
                        </div><!-- /.feature-post -->
                        <div class="content-post">
                            <span class="category">Advisory Plan</span>
                            <h2 class="title-post"><a href="single-post.html">Bill Gates’ foundation to sup-port Immunocore work</a></h2>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
                            <a href="#" class="readmore">READ MORE</a>
                        </div><!-- /.contetn-post -->
                    </div><!-- /.entry-border -->
                ...
                <article class="entry border-shadow clearfix">
                    <div class="entry-border clearfix">
                        <div class="featured-post">
                            <a href="single-post.html"> <img src="images/blog/pl4.jpg" alt="image"></a>
                        </div><!-- /.feature-post -->
                        <div class="content-post">
                            <span class="category">Advisory Plan</span>
                            <h2 class="title-post"><a href="single-post.html">FSP to hold property seminar at Green Park</a></h2>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
                            <a href="#" class="readmore">READ MORE</a>
                        </div><!-- /.contetn-post -->
                    </div><!-- /.entry-border -->
                ...
                <article class="entry border-shadow clearfix">
                    <div class="entry-border clearfix">
                        <div class="featured-post">
                            <a href="single-post.html"> <img src="images/blog/pl5.jpg" alt="image"></a>
                        </div><!-- /.feature-post -->
                        <div class="content-post">
                            <span class="category">Advisory Plan</span>
                            <h2 class="title-post"><a href="single-post.html">Bill Gates’ foundation to sup-port Immunocore work</a></h2>
